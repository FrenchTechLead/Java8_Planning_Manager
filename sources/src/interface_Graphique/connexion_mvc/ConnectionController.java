...
import interface_Graphique.admin_mvc.AdminController;
import interface_Graphique.admin_mvc.AdminModel;
import interface_Graphique.admin_mvc.AdminView;
...
public class ConnectionController {
    ...
    private void checkUser(){
        ...
        if (connected){
        	...
        	AdminModel a_model = new AdminModel(model.getDb());
        	AdminView a_view = new AdminView();
        	AdminController a_controller = new AdminController(a_model, a_view);
        	a_controller.control();	
        	break;
